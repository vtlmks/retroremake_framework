...
gcc -O2 -flto loader.c -ffunction-sections -fdata-sections -o loader -Wl,--gc-sections -Iinclude -I../include -Llib/linux64 -lasound -l:libglfw3.a -lm -lGL -ldl -pthread
ctime -end .loader_linux $?

# Build Windows version
echo "Building windows version."
ctime -begin .loader_windows
x86_64-w64-mingw32-gcc -O2 -flto loader.c -ffunction-sections -fdata-sections -o loader -Iinclude -I../include -Llib/win32 -l:libglfw3.a -lwinmm -lntdll -lgdi32 -luser32 -lopengl32 -ladvapi32
